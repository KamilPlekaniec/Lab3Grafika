...
public class SubroutineHierarchy extends JPanel {
    ...
    private void rotatingPoly(Graphics2D g2) { // (DELETE THIS EXAMPLE)
    ...
    private static void filledPoly(Graphics2D g2) {
        int N = 8;
        int R = 100;
